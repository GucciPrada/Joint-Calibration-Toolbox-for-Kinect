...
fprintf('                   %c[%3.2f   %3.2f]\n', ...
  pm, depth_calib_error.rK{k}(1,1),depth_calib_error.rK{k}(2,2));
end
...
if(~isempty(depth_calib_error))
fprintf('                    %c[%3.2f   %3.2f]\n', ...
  pm, depth_calib_error.rK{k}(1,3),depth_calib_error.rK{k}(2,3));
end
