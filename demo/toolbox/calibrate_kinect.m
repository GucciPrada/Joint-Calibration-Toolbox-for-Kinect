...
function [calib,calib_jacobian,color_error,depth_error]=calibrate_kinect(options,rgb_grid_p,rgb_grid_x,depth_plane_points,depth_plane_disparity,calib0)
  ...
  % The following option switches means that once one of the swtiches is *off*,
  % then it will be meaningful to calibrate (i.e.,enter cost function).
  % Vice versa, if all parameters are fixed, it is meangingless to calibrate
