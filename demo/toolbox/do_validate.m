...
function [mean_color_error, mean_depth_error, std_color_error, std_depth_error] = do_validate(calib)
...
for i=1:icount
  ...
  mean_color_error(i) = im_mean(1);
  mean_depth_error(i) = nanmean(a(:));
  std_color_error(i) = im_std(1);
  std_depth_error(i) = nanstd(a(:));
