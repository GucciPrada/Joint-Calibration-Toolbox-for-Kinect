...
n_rand_test = 10; % number of random tests
...
% max_n_imgs = max(max(rgb_ind), max(imd_ind));
max_n_imgs = max(length(rgb_ind), length(imd_ind));

% %% Calibration based on Random Tests
% for m = n_img_start_num : max_n_imgs
%     
...
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         save_calib_file = ['../calib_ret/calib_' dataset_name sprintf('_rand_test_%d_nimg_%d', k, m)];
...
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         load_calib_file = ['../calib_ret/calib_' dataset_name sprintf('_rand_test_%d_nimg_%d', k, m)];
...
% end
% 
% save(['../calib_ret/rand_test_ret_' validate_dataset_name '.mat'], 'test_mean_color_error', 'test_mean_depth_error', 'test_std_color_error', 'test_std_depth_error');
% save(['../calib_ret/rand_calib_ret_' dataset_name '.mat'], 'calib_mean_color_error', 'calib_mean_depth_error', 'calib_std_color_error', 'calib_std_depth_error');
